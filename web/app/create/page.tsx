...
const postTypes: { value: ContentType; label: string; icon: React.ReactNode; description: string }[] = [
  ...
  },
  {
    ...
    description: "Ask for advice or help from the community",
  },
  {
    value: "poll",
    label: "Poll",
    icon: <BarChart3 className="h-5 w-5" />,
    description: "Get opinions with a quick vote",
  },
];
...
export default function CreatePostPage() {
  ...
  const defaultSection = searchParams.get("section") as ContentSection | null;

  const [postType, setPostType] = React.useState<ContentType>("forum_post");
  const [section, setSection] = React.useState<ContentSection | null>(defaultSection);
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">
                Choose a section <span className="text-destructive">*</span>
              </label>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>Make it descriptive and clear</span>
              ...
              {!isPreview ? (
                <>
                  ...
                  <Textarea
                    ...
                    className="min-h-[250px] rounded-t-none border-t-0"
                  />
                </>
              ) : (
                <div className="min-h-[250px] p-4 border rounded-md bg-muted/30">
                  {body ? (
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Tags help others find your post. {tags.length}/5 tags used.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your username won't be shown on this post
                </p>
              </div>
              <button
